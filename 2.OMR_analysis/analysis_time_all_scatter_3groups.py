...
def processAngles(experiment, data_first, data_first_raw):
    ...
    to_save['avg_first_3'] = mean_first_3
    to_save['sem_first_3'] = sem_first_3.data if np.ma.isMaskedArray(sem_first_3) else sem_first_3


    to_save['raw_first_1'] = avg_first_1
    to_save['raw_first_2'] = avg_first_2
    to_save['raw_first_3'] = avg_first_3
    ...
    to_save['raw_value_3'] = data_first_raw[group_3]  # average across stimuli and trials and take the mean
...
def plotHistogram(experiment, prob=False):
    ...
    mean_3 = np.nanmean(raw_3 * 1000)
    mean_sem_3 = sem(raw_3 * 1000, nan_policy='omit')
...
if __name__ == '__main__':
    ...
    experiment = '2026_04_15_paula_circadianshift'
