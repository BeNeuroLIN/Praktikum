...
def plotHistogram(experiment, num_bins):
    ...
    if stimuli % 2 == 0:
        ...
        sem_3 = np.sqrt((sem_3[:half] ** 2 + sem_3[half:] ** 2) / 2.0)
        ...
        sem_3 = np.sqrt((sem_3[:half] ** 2 + sem_3[half:-1] ** 2) / 2.0)
